class Quincite::UI::TextButton < Quincite::UI::TextLabel
  ...
  def initialize(id='', text='', x=0, y=0, *argv)
    super(id, text, x, y)
    @disable_color = Gosu::Color.new(255,127,127,127)
    @active_color = Gosu::Color.new(255,127,255,223)
    @hover_color = Gosu::Color.new(255,255,223,127)
  end

  def onclick=(event_handler=Proc.new, &proc)
